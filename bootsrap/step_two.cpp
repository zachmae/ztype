...
struct entity_t {
    ...
    entity_t() { std::cout << "test" << std::endl; };
...
class registry {
    public :
         ...
         * @param e 
         * 
         * ! mais dans quel dimmenssion je suis !!!
         */
/*        void kill_entity(entity_t const &e)
        {
            sparse_array<registry::entity_t> &a = get_components<entity_t>();
            a.erase(a.size());
        };
...
/*        template <typename Component>
        ...
        {
            return _registry.get_components<Component>().insert_at(to.id, std::move(c));
        };
    ...
    private :
        ...
        // i manager _components_entities;
        std::function<void(registry &, entity_t const &)> f;
